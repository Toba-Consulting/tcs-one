...
public class TCSInquiryReactivate extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		if (inq.get_ValueAsString("DocStatus").equalsIgnoreCase("CL") ||
			...
			return "Only Completed Inquiry can be voided";
			...
			if (inq.hasMatchRfQ()) {
				return "Error: Please Void Related RfQ First";
			}
			
			inq.setProcessed(false);
			inq.set_ValueOfColumn("DocStatus", "IP");
			...
			String message = Msg.parseTranslation(getCtx(), "@InquiryReactivated@ " + inq.getDocumentNo());
