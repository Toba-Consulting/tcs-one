...
public class TCS_CreateLeftoverMatchAllocation extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		String sqlWhere="DocStatus=? AND NOT EXISTS(SELECT 1 FROM T_MatchAllocation ta WHERE ta.C_AllocationHdr_ID=C_AllocationHdr.C_AllocationHdr_ID)";
//		int[] AllocationIDs = new Query(getCtx(), MAllocationHdr.Table_Name, "DocStatus=?", get_TrxName())
		int[] AllocationIDs = new Query(getCtx(), MAllocationHdr.Table_Name, sqlWhere, get_TrxName())
