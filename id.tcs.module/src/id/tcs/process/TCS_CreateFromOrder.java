...
//public class TCS_CreateFromOrder extends SvrProcess
//{
...
//		if (log.isLoggable(Level.CONFIG)) log.config("C_Order=" + order);
//
//		// Lines
//		StringBuilder sql = new StringBuilder();
//		sql.append("SELECT t.T_Selection_ID, t.ViewID, v.AD_Table_ID, v.Line, v.C_Order_ID, v.M_Requisition_ID, ");
//		sql.append("v.Qty, v.C_UOM_ID, v.M_Locator_ID, v.M_Product_ID, v.C_OrderLine_ID, v.M_RequisitionLine_ID ");
//		sql.append("FROM T_Selection t, C_Order_CreateFrom_v v ");
//		sql.append("WHERE (t.ViewID || '_' || t.T_Selection_ID)=(v.AD_Table_ID || '_' || v.C_Order_CreateFrom_v) ");
...
//				
//		MOrder m_order = null;
//		MRequisition m_requisition = null;
//		
...
//			int M_Requisition_ID = value != null ? ((Number) value).intValue() : 0;
//			if (M_Requisition_ID != 0 && (m_requisition == null || m_requisition.getM_Requisition_ID() != M_Requisition_ID))
//				m_requisition = new MRequisition(getCtx(), M_Requisition_ID, get_TrxName());
//			
//			ColumnName = "Qty";
//			key = ColumnName + "_" + T_Selection_ID;
//			value = selectionValueMap.get(key);
