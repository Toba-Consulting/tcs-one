...
public class TCSInquiryClose extends SvrProcess {
	...
	protected String doIt() throws Exception {
		...
		if (inq.get_ValueAsString("DocStatus").equalsIgnoreCase("CL") ||
			...
			inq.set_ValueOfColumn("DocStatus", "CL");
			...
			String message = Msg.parseTranslation(getCtx(), "@InquiryClosed@ " + inq.getDocumentNo());
