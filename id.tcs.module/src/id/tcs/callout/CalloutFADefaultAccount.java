...
public class CalloutFADefaultAccount implements IColumnCallout{
	...
	public String start(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value, Object oldValue) {
		...
		if (mField.getColumnName().equals("A_Accumdepreciation_Acct") 
				|| mField.getColumnName().equals("A_Asset_Acct")
				|| mField.getColumnName().equals("A_Asset_Clearing_Acct")
				|| mField.getColumnName().equals("A_Depreciation_Acct")
				|| mField.getColumnName().equals("A_Disposal_Gain_Acct")
				|| mField.getColumnName().equals("A_Disposal_Loss_Acct")
				|| mField.getColumnName().equals("A_Disposal_Revenue_Acct") )
	...
	//Set Element Value
		protected String setElementValue(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value, Object oldValue) {
			...
			if (mField.getColumnName().equals("A_Accumdepreciation_Acct")) {
				mTab.setValue("C_ElementValue_ADepre_ID", validCombination.getAccount_ID());
			}
			else if (mField.getColumnName().equals("A_Asset_Acct")) {
				mTab.setValue("C_ElementValue_AssetAcct_ID", validCombination.getAccount_ID());
			}
			else if (mField.getColumnName().equals("A_Asset_Clearing_Acct")) {
				mTab.setValue("C_ElementValue_AClearing_ID", validCombination.getAccount_ID());
			}
			else if (mField.getColumnName().equals("A_Depreciation_Acct")) {
				mTab.setValue("C_ElementValue_Depre_ID", validCombination.getAccount_ID());
			}
			else if (mField.getColumnName().equals("A_Disposal_Gain_Acct")) {
				mTab.setValue("C_ElementValue_DGain_ID", validCombination.getAccount_ID());
			}
			else if (mField.getColumnName().equals("A_Disposal_Loss_Acct")) {
				mTab.setValue("C_ElementValue_DLoss_ID", validCombination.getAccount_ID());
			}
			else if (mField.getColumnName().equals("A_Disposal_Revenue_Acct")) {
				mTab.setValue("C_ElementValue_DRevenue_ID", validCombination.getAccount_ID());
			}
