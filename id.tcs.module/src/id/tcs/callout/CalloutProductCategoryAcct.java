package org.productcategory.callout;
...
import org.productcategory.model.MProductCategoryAcct;
import org.productcategory.model.MValidCombination;


public class CalloutProductCategoryAcct implements IColumnCallout{

	@Override
	public String start(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value, Object oldValue) {
		// TODO Auto-generated method stub
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_Asset_ID))
			return setProductAsset(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_CA_ID))
			return setCostAdj(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_COGS_ID))
			return setCOGS(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_PPV_ID))
			return setPurchasePriceV(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_TDR_ID))
			return setTradeDiscountR(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_RV_ID))
			return setRateVariance(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_LCC_ID))
			return setLandedCostC(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_PE_ID))
			return setProductExpense(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_IC_ID))
			return setInventoryClearing(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_Revenue_ID))
			return setProductRevenue(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_IPV_ID))
			return setInvoicePriceV(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_TDG_ID))
			return setTradeDiscountG(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_C_ElementValue_ACV_ID))
			return setAverageCostV(ctx, WindowNo, mTab, mField, value, oldValue);
		if (mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_Asset_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_CostAdjustment_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_COGS_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_PurchasePriceVariance_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_TradeDiscountRec_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_RateVariance_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_LandedCostClearing_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_Expense_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_InventoryClearing_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_Revenue_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_InvoicePriceVariance_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_TradeDiscountGrant_Acct)
				|| mField.getColumnName().equals(MProductCategoryAcct.COLUMNNAME_P_AverageCostVariance_Acct)
				)
	...
	//Set Product Asset
		...
		protected String setElementValue(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value, Object oldValue) {
			...
			if (mField.getColumnName().equals("P_Asset_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_Asset_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_CostAdjustment_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_CA_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_COGS_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_COGS_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_PurchasePriceVariance_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_PPV_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_TradeDiscountRec_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_TDR_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_RateVariance_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_RV_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_LandedCostClearing_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_LCC_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_Expense_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_PE_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_InventoryClearing_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_IC_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_Revenue_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_Revenue_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_InvoicePriceVariance_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_IPV_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_TradeDiscountGrant_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_TDG_ID, validCombination.getAccount_ID());
			}else if (mField.getColumnName().equals("P_AverageCostVariance_Acct")) {
				mTab.setValue(MProductCategoryAcct.COLUMNNAME_C_ElementValue_ACV_ID, validCombination.getAccount_ID());
			}
