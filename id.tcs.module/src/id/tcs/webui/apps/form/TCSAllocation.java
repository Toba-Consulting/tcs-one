...
public class TCSAllocation
{
	...
	//iqbal
	public String		m_poReference = null;
	...
	public Vector<Vector<Object>> getInvoiceData(boolean isMultiCurrency, Object date, IMiniTable invoiceTable)
	{
		...
		*/							// #9
		...
		try
		{
			...
			if(isMultiCurrency && m_poReference != null)
				pstmt.setString(8, m_poReference);
			else if(!isMultiCurrency && m_poReference != null)
				pstmt.setString(9, m_poReference);
