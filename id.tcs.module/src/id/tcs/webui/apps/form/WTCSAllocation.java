 ...
 */
public class WTCSAllocation extends TCSAllocation
	implements IFormController, EventListener<Event>, WTableModelListener, ValueChangeListener
{
	...
	private void zkInit() throws Exception
	{
		...
		*/
		...
		/* @win
		poreferenceLabel.setText("No Polis");
		poreferenceLabel.setStyle("text-align: left");
		poreferenceField.setText(Msg.getMsg(Env.getCtx(), ""));
		poreferenceField.setStyle("text-align: left");
		*/
	...
	protected void layoutParameterAndSummary() {
		...
		row = rows.newRow();
		/* @win
		row.appendCellChild(poreferenceLabel.rightAlign(),2);
		ZKUpdateUtil.setHflex(poreferenceField, "true");
		row.appendCellChild(poreferenceField);
		*/
		row.appendCellChild(DescriptionLabel.rightAlign());
		ZKUpdateUtil.setHflex(DescriptionField, "true");
	...
	public void dynInit() throws Exception
	{
		...
		AD_Column_ID = 12317; //C_Period.AD_Org_ID (needed to allow org 0)
	...
	{
		/* @win
		if(poreferenceField.getText().length() == 0)
			m_poReference = null;
		else
		{
			m_poReference = poreferenceField.getText();
		}
		*/
		checkBPartner();
