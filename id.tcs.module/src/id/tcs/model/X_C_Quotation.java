...
public class X_C_Quotation extends PO implements I_C_Quotation, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20160421L;
...
// 5
	...
	/** Set C_Quotation_UU.
		@param C_Quotation_UU C_Quotation_UU	  */
	public void setC_Quotation_UU (String C_Quotation_UU)
	{
		set_Value (COLUMNNAME_C_Quotation_UU, C_Quotation_UU);
	}

	/** Get C_Quotation_UU.
		@return C_Quotation_UU	  */
	public String getC_Quotation_UU () 
	{
		return (String)get_Value(COLUMNNAME_C_Quotation_UU);
	}
	...
	/** Set Quotation Accepted?.
		@param IsQuotationAccepted Quotation Accepted?	  */
	public void setIsQuotationAccepted (boolean IsQuotationAccepted)
	{
		set_Value (COLUMNNAME_IsQuotationAccepted, Boolean.valueOf(IsQuotationAccepted));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsQuotationAccepted);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
