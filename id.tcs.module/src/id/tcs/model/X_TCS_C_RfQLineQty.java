...
public class X_TCS_C_RfQLineQty extends PO implements I_TCS_C_RfQLineQty, I_Persistent 
{
    ...
    public X_TCS_C_RfQLineQty (Properties ctx, int C_RfQLineQty_ID, String trxName)
    {
...
// 1
    ...
    /** Load Constructor */
    public X_TCS_C_RfQLineQty (Properties ctx, ResultSet rs, String trxName)
    {
