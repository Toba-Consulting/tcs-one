...
/** Generated Model for TCS_WithholdingCalcLine
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_TCS_WithholdingCalcLine extends PO implements I_TCS_WithholdingCalcLine, I_Persistent 
{
    ...
    public X_TCS_WithholdingCalcLine (Properties ctx, int TCS_WithholdingCalcLine_ID, String trxName)
    {
      super (ctx, TCS_WithholdingCalcLine_ID, trxName);
      /** if (TCS_WithholdingCalcLine_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_TCS_WithholdingCalcLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TCS_WithholdingCalcLine[")
    ...
    {
		return (I_TCS_WithholdingCalc)MTable.get(getCtx(), I_TCS_WithholdingCalc.Table_Name)
			.getPO(getTCS_WithholdingCalc_ID(), get_TrxName());	}
	...
	/** Set Withholding Calculation Line.
		@param TCS_WithholdingCalcLine_ID Withholding Calculation Line	  */
	public void setTCS_WithholdingCalcLine_ID (int TCS_WithholdingCalcLine_ID)
	{
		if (TCS_WithholdingCalcLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_TCS_WithholdingCalcLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_TCS_WithholdingCalcLine_ID, Integer.valueOf(TCS_WithholdingCalcLine_ID));
	}

	/** Get Withholding Calculation Line.
		@return Withholding Calculation Line	  */
	public int getTCS_WithholdingCalcLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_TCS_WithholdingCalcLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set TCS_WithholdingCalcLine_UU.
		@param TCS_WithholdingCalcLine_UU TCS_WithholdingCalcLine_UU	  */
	public void setTCS_WithholdingCalcLine_UU (String TCS_WithholdingCalcLine_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TCS_WithholdingCalcLine_UU, TCS_WithholdingCalcLine_UU);
	}

	/** Get TCS_WithholdingCalcLine_UU.
		@return TCS_WithholdingCalcLine_UU	  */
	public String getTCS_WithholdingCalcLine_UU () 
	{
		return (String)get_Value(COLUMNNAME_TCS_WithholdingCalcLine_UU);
	}
