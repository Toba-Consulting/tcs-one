...
/** Generated Interface for TCS_AdvSettlement
 *  @author iDempiere (generated) 
 *  @version Release 5.1
 */
@SuppressWarnings("all")
public interface I_TCS_AdvSettlement 
{

    /** TableName=TCS_AdvSettlement */
    public static final String Table_Name = "TCS_AdvSettlement";
    ...
    public static final String COLUMNNAME_AmountReimbursed = "AmountReimbursed";
    ...
    public static final String COLUMNNAME_AmountReturned = "AmountReturned";
    ...
    public static final String COLUMNNAME_isReimbursed = "isReimbursed";
    ...
    /** Column name TCS_AdvSettlement_UU */
    public static final String COLUMNNAME_TCS_AdvSettlement_UU = "TCS_AdvSettlement_UU";

	/** Set TCS_AdvSettlement_UU	  */
	public void setTCS_AdvSettlement_UU (String TCS_AdvSettlement_UU);

	/** Get TCS_AdvSettlement_UU	  */
	public String getTCS_AdvSettlement_UU();
