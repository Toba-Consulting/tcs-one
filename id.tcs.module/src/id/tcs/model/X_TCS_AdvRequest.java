...
/** Generated Model for TCS_AdvRequest
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_TCS_AdvRequest extends PO implements I_TCS_AdvRequest, I_Persistent 
{
...
// CO
    ...
    /** Load Constructor */
    public X_TCS_AdvRequest (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TCS_AdvRequest[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_Days, Integer.valueOf(Days));
	}
	...
	/** Set TCS_AdvRequest_UU.
		@param TCS_AdvRequest_UU TCS_AdvRequest_UU	  */
	public void setTCS_AdvRequest_UU (String TCS_AdvRequest_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TCS_AdvRequest_UU, TCS_AdvRequest_UU);
	}

	/** Get TCS_AdvRequest_UU.
		@return TCS_AdvRequest_UU	  */
	public String getTCS_AdvRequest_UU () 
	{
		return (String)get_Value(COLUMNNAME_TCS_AdvRequest_UU);
	}
}