...
public class X_TCS_C_RfQ_TopicSubscriber extends PO implements I_TCS_C_RfQ_TopicSubscriber, I_Persistent 
{
    ...
    public X_TCS_C_RfQ_TopicSubscriber (Properties ctx, int C_RfQ_TopicSubscriber_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_TCS_C_RfQ_TopicSubscriber (Properties ctx, ResultSet rs, String trxName)
    {
