 ...
 */
public class TCS_MRfQResponseLineQty extends X_TCS_C_RfQResponseLineQty implements Comparator<Object>
{
	/**
	 * 
	 */
	 ...
	 */
	public TCS_MRfQResponseLineQty (Properties ctx, int C_RfQResponseLineQty_ID, String trxName)
	{
	 ...
	 *	@param trxName transaction
	 */
	public TCS_MRfQResponseLineQty (Properties ctx, ResultSet rs, String trxName)
	{
	 ...
	 *	@param qty qty
	 */
	public TCS_MRfQResponseLineQty (TCS_MRfQResponseLine line, TCS_MRfQLineQty qty)
	{
	...
	/**	RfQ Line Qty			*/
	private TCS_MRfQLineQty		m_rfqQty = null;
	
	/**
	 * 	Get RfQ Line Qty
	 *	@return RfQ Line Qty
	 */
	public TCS_MRfQLineQty getRfQLineQty()
	{
		if (m_rfqQty == null)
			m_rfqQty = TCS_MRfQLineQty.get (getCtx(), getC_RfQLineQty_ID(), get_TrxName()); 
		return m_rfqQty;
	}	//	getRfQLineQty
	...
	public int compare(Object o1, Object o2)
	{
		...
		TCS_MRfQResponseLineQty q1 = null;
		TCS_MRfQResponseLineQty q2 = null;
		if (o1 instanceof TCS_MRfQResponseLineQty)
			q1 = (TCS_MRfQResponseLineQty)o1;
		else
			throw new ClassCastException("o1");
		if (o2 instanceof TCS_MRfQResponseLineQty)
			q2 = (TCS_MRfQResponseLineQty)o2;
		else
	...
	{
    	if (obj instanceof TCS_MRfQResponseLineQty)
    	{
    		TCS_MRfQResponseLineQty cmp = (TCS_MRfQResponseLineQty)obj;
