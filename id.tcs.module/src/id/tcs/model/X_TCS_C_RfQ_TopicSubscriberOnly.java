...
public class X_TCS_C_RfQ_TopicSubscriberOnly extends PO implements I_TCS_C_RfQ_TopicSubscriberOnly, I_Persistent 
{
    ...
    public X_TCS_C_RfQ_TopicSubscriberOnly (Properties ctx, int C_RfQ_TopicSubscriberOnly_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_TCS_C_RfQ_TopicSubscriberOnly (Properties ctx, ResultSet rs, String trxName)
    {
