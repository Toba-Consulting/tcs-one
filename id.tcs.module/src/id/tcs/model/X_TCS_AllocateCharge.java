...
/** Generated Model for TCS_AllocateCharge
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_TCS_AllocateCharge extends PO implements I_TCS_AllocateCharge, I_Persistent 
{
    ...
    /** Load Constructor */
    public X_TCS_AllocateCharge (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TCS_AllocateCharge[")
	...
	public void setTCS_AllocateCharge_ID (int TCS_AllocateCharge_ID)
	{
		if (TCS_AllocateCharge_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_TCS_AllocateCharge_ID, null);
		else 
