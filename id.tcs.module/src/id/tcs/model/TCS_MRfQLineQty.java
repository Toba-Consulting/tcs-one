 ...
 */
public class TCS_MRfQLineQty extends X_TCS_C_RfQLineQty
{
	/**
	 * 
	 */
	 ...
	 *	@return MRfQLineQty
	 */
	public static TCS_MRfQLineQty get (Properties ctx, int C_RfQLineQty_ID, String trxName)
	{
		Integer key = new Integer (C_RfQLineQty_ID);
		TCS_MRfQLineQty retValue = (TCS_MRfQLineQty) s_cache.get (key);
		if (retValue != null)
			return retValue;
		retValue = new TCS_MRfQLineQty (ctx, C_RfQLineQty_ID, trxName);
	...
	/**	Cache						*/
	private static CCache<Integer,TCS_MRfQLineQty>	s_cache	= new CCache<Integer,TCS_MRfQLineQty>(Table_Name, 20);
	 ...
	 *	@param trxName transaction
	 */
	public TCS_MRfQLineQty (Properties ctx, int C_RfQLineQty_ID, String trxName)
	{
	 ...
	 *	@param trxName transaction
	 */
	public TCS_MRfQLineQty (Properties ctx, ResultSet rs, String trxName)
	{
	 ...
	 *	@param line RfQ line
	 */
	public TCS_MRfQLineQty (TCS_MRfQLine line)
	{
