...
public class X_C_AcctSchema_GL extends PO implements I_C_AcctSchema_GL, I_Persistent 
{
	...
	public org.compiere.model.I_C_ElementValue getC_ElementValue_CB() throws RuntimeException
    {
		return (org.compiere.model.I_C_ElementValue)MTable.get(getCtx(), org.compiere.model.I_C_ElementValue.Table_Name)
			.getPO(getC_ElementValue_CB_ID(), get_TrxName());	}

	/** Set Account Currency Balancing.
		@param C_ElementValue_CB_ID Account Currency Balancing	  */
	public void setC_ElementValue_CB_ID (int C_ElementValue_CB_ID)
	{
		if (C_ElementValue_CB_ID < 1) 
			set_Value (COLUMNNAME_C_ElementValue_CB_ID, null);
		else 
			set_Value (COLUMNNAME_C_ElementValue_CB_ID, Integer.valueOf(C_ElementValue_CB_ID));
	}

	/** Get Account Currency Balancing.
		@return Account Currency Balancing	  */
	public int getC_ElementValue_CB_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_ElementValue_CB_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public org.compiere.model.I_C_ElementValue getC_ElementValue_CO() throws RuntimeException
    {
		return (org.compiere.model.I_C_ElementValue)MTable.get(getCtx(), org.compiere.model.I_C_ElementValue.Table_Name)
			.getPO(getC_ElementValue_CO_ID(), get_TrxName());	}

	/** Set Account Commitment Offset.
		@param C_ElementValue_CO_ID Account Commitment Offset	  */
	public void setC_ElementValue_CO_ID (int C_ElementValue_CO_ID)
	{
		if (C_ElementValue_CO_ID < 1) 
			set_Value (COLUMNNAME_C_ElementValue_CO_ID, null);
		else 
			set_Value (COLUMNNAME_C_ElementValue_CO_ID, Integer.valueOf(C_ElementValue_CO_ID));
	}

	/** Get Account Commitment Offset.
		@return Account Commitment Offset	  */
	public int getC_ElementValue_CO_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_ElementValue_CO_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public org.compiere.model.I_C_ElementValue getC_ElementValue_COS() throws RuntimeException
    {
		return (org.compiere.model.I_C_ElementValue)MTable.get(getCtx(), org.compiere.model.I_C_ElementValue.Table_Name)
			.getPO(getC_ElementValue_COS_ID(), get_TrxName());	}

	/** Set Account Commitment Offset Sales.
		@param C_ElementValue_COS_ID Account Commitment Offset Sales	  */
	public void setC_ElementValue_COS_ID (int C_ElementValue_COS_ID)
	{
		if (C_ElementValue_COS_ID < 1) 
			set_Value (COLUMNNAME_C_ElementValue_COS_ID, null);
		else 
			set_Value (COLUMNNAME_C_ElementValue_COS_ID, Integer.valueOf(C_ElementValue_COS_ID));
	}

	/** Get Account Commitment Offset Sales.
		@return Account Commitment Offset Sales	  */
	public int getC_ElementValue_COS_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_ElementValue_COS_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public org.compiere.model.I_C_ElementValue getC_ElementValue_IDF() throws RuntimeException
    {
		return (org.compiere.model.I_C_ElementValue)MTable.get(getCtx(), org.compiere.model.I_C_ElementValue.Table_Name)
			.getPO(getC_ElementValue_IDF_ID(), get_TrxName());	}

	/** Set Account Intercompany Due From.
		@param C_ElementValue_IDF_ID Account Intercompany Due From	  */
	public void setC_ElementValue_IDF_ID (int C_ElementValue_IDF_ID)
	{
		if (C_ElementValue_IDF_ID < 1) 
			set_Value (COLUMNNAME_C_ElementValue_IDF_ID, null);
		else 
			set_Value (COLUMNNAME_C_ElementValue_IDF_ID, Integer.valueOf(C_ElementValue_IDF_ID));
	}

	/** Get Account Intercompany Due From.
		@return Account Intercompany Due From	  */
	public int getC_ElementValue_IDF_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_ElementValue_IDF_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public org.compiere.model.I_C_ElementValue getC_ElementValue_IDT() throws RuntimeException
    {
		return (org.compiere.model.I_C_ElementValue)MTable.get(getCtx(), org.compiere.model.I_C_ElementValue.Table_Name)
			.getPO(getC_ElementValue_IDT_ID(), get_TrxName());	}

	/** Set Account Intercompany Due To.
		@param C_ElementValue_IDT_ID Account Intercompany Due To	  */
	public void setC_ElementValue_IDT_ID (int C_ElementValue_IDT_ID)
	{
		if (C_ElementValue_IDT_ID < 1) 
			set_Value (COLUMNNAME_C_ElementValue_IDT_ID, null);
		else 
			set_Value (COLUMNNAME_C_ElementValue_IDT_ID, Integer.valueOf(C_ElementValue_IDT_ID));
	}

	/** Get Account Intercompany Due To.
		@return Account Intercompany Due To	  */
	public int getC_ElementValue_IDT_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_ElementValue_IDT_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public org.compiere.model.I_C_ElementValue getC_ElementValue_PPVO() throws RuntimeException
    {
		return (org.compiere.model.I_C_ElementValue)MTable.get(getCtx(), org.compiere.model.I_C_ElementValue.Table_Name)
			.getPO(getC_ElementValue_PPVO_ID(), get_TrxName());	}

	/** Set Account PPV Offset.
		@param C_ElementValue_PPVO_ID Account PPV Offset	  */
	public void setC_ElementValue_PPVO_ID (int C_ElementValue_PPVO_ID)
	{
		if (C_ElementValue_PPVO_ID < 1) 
			set_Value (COLUMNNAME_C_ElementValue_PPVO_ID, null);
		else 
			set_Value (COLUMNNAME_C_ElementValue_PPVO_ID, Integer.valueOf(C_ElementValue_PPVO_ID));
	}

	/** Get Account PPV Offset.
		@return Account PPV Offset	  */
	public int getC_ElementValue_PPVO_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_ElementValue_PPVO_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}

	public org.compiere.model.I_C_ElementValue getC_ElementValue_SB() throws RuntimeException
    {
		return (org.compiere.model.I_C_ElementValue)MTable.get(getCtx(), org.compiere.model.I_C_ElementValue.Table_Name)
			.getPO(getC_ElementValue_SB_ID(), get_TrxName());	}

	/** Set Account Suspense Balancing.
		@param C_ElementValue_SB_ID Account Suspense Balancing	  */
	public void setC_ElementValue_SB_ID (int C_ElementValue_SB_ID)
	{
		if (C_ElementValue_SB_ID < 1) 
			set_Value (COLUMNNAME_C_ElementValue_SB_ID, null);
		else 
			set_Value (COLUMNNAME_C_ElementValue_SB_ID, Integer.valueOf(C_ElementValue_SB_ID));
	}

	/** Get Account Suspense Balancing.
		@return Account Suspense Balancing	  */
	public int getC_ElementValue_SB_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_ElementValue_SB_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
