...
/** Generated Model for TCS_AdvSettlement
 *  @author iDempiere (generated) 
 *  @version Release 5.1 - $Id$ */
public class X_TCS_AdvSettlement extends PO implements I_TCS_AdvSettlement, I_Persistent 
{
    ...
    public X_TCS_AdvSettlement (Properties ctx, int TCS_AdvSettlement_ID, String trxName)
    {
      super (ctx, TCS_AdvSettlement_ID, trxName);
      /** if (TCS_AdvSettlement_ID == 0)
        {
			setC_BPartner_ID (0);
			setC_DocType_ID (0);
...
// @#Date@
    ...
    /** Load Constructor */
    public X_TCS_AdvSettlement (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_TCS_AdvSettlement[")
        .append(get_ID()).append("]");
      return sb.toString();
    }

	/** Set Amount Reimbursed.
		@param AmountReimbursed Amount Reimbursed	  */
	public void setAmountReimbursed (BigDecimal AmountReimbursed)
	{
		set_Value (COLUMNNAME_AmountReimbursed, AmountReimbursed);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_AmountReimbursed);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set Amount Returned.
		@param AmountReturned Amount Returned	  */
	public void setAmountReturned (BigDecimal AmountReturned)
	{
		set_Value (COLUMNNAME_AmountReturned, AmountReturned);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_AmountReturned);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	/** Set is Reimbursed.
		@param isReimbursed is Reimbursed	  */
	public void setisReimbursed (boolean isReimbursed)
	{
		set_Value (COLUMNNAME_isReimbursed, Boolean.valueOf(isReimbursed));
	}

	/** Get is Reimbursed.
		@return is Reimbursed	  */
	public boolean isReimbursed () 
	{
		Object oo = get_Value(COLUMNNAME_isReimbursed);
		if (oo != null) 
		{
	...
	/** Set TCS_AdvSettlement_UU.
		@param TCS_AdvSettlement_UU TCS_AdvSettlement_UU	  */
	public void setTCS_AdvSettlement_UU (String TCS_AdvSettlement_UU)
	{
		set_ValueNoCheck (COLUMNNAME_TCS_AdvSettlement_UU, TCS_AdvSettlement_UU);
	}

	/** Get TCS_AdvSettlement_UU.
		@return TCS_AdvSettlement_UU	  */
	public String getTCS_AdvSettlement_UU () 
	{
		return (String)get_Value(COLUMNNAME_TCS_AdvSettlement_UU);
	}
}