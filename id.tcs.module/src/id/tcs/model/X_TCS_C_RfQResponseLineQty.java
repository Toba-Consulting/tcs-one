...
public class X_TCS_C_RfQResponseLineQty extends PO implements I_TCS_C_RfQResponseLineQty, I_Persistent 
{
    ...
    public X_TCS_C_RfQResponseLineQty (Properties ctx, int C_RfQResponseLineQty_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_TCS_C_RfQResponseLineQty (Properties ctx, ResultSet rs, String trxName)
    {
