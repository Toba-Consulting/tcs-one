...
public class TCS_MAllocationLine extends MAllocationLine
{
	 ...
	 *	@param trxName name
	 */
	public TCS_MAllocationLine (Properties ctx, int C_AllocationLine_ID, String trxName)
	{
	 ...
	 */
	public TCS_MAllocationLine (Properties ctx, ResultSet rs, String trxName)
	{
	 ...
	 *	@param parent parent
	 */
	public TCS_MAllocationLine (TCS_MAllocationHdr parent)
	{
	 ...
	 */
	public TCS_MAllocationLine (TCS_MAllocationHdr parent, BigDecimal Amount, 
	...
	/** Allocation Header		*/
	private TCS_MAllocationHdr	m_parent = null;
	
	/**
	 * 	Get Parent
	 *	@return parent
	 */
	public TCS_MAllocationHdr getParent()
	{
		if (m_parent == null)
			m_parent = new TCS_MAllocationHdr (getCtx(), getC_AllocationHdr_ID(), get_TrxName());
		return m_parent;
	}	//	getParent
	 ...
	 *	@param parent parent
	 */
	protected void setParent (TCS_MAllocationHdr parent)
	{
		m_parent = parent;
	}	//	setParent
